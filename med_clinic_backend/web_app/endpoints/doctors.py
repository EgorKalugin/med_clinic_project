...
from med_clinic_backend.models.models import Doctor
...
@router.get("/", name="Doctor:get", response_model=list[Doctor])
...
@router.get("/{doctor_id}", name="Doctor:get_by_id", response_model=Doctor)
